...
//     const matchesDuration = !filters.duration || property.durationInMonths >= Number.parseInt(filters.duration)
...
export default function PropertiesPage() {
  ...
  const filteredProperties = (properties || []).filter((property) => {
    ...
    const matchesDuration = !filters.duration || property.durationInMonths >= Number(filters.duration)
