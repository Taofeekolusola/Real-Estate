    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex">
          <div
            className="flex-1 bg-cover bg-center animate-float"
            style={{ backgroundImage: "url('/images/house8.jpeg')" }}
          />
          <div
            className="flex-1 bg-cover bg-center animate-float"
            style={{ backgroundImage: "url('/images/house9.jpeg')" }}
          />
          <div
            className="flex-1 bg-cover bg-center animate-float"
            style={{ backgroundImage: "url('/images/house10.jpeg')" }}
          />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-white max-w-3xl mx-auto drop-shadow">
