...
export default function LandlordRatingsPage() {
  ...
  const averageRating =
    ratingsArray.length > 0 ? ratingsArray.reduce((sum: number, rating: Rating) => sum + rating.rating, 0) / ratingsArray.length : 0
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-purple-600 mb-2">
                    {ratingsArray.filter((r: Rating) => r.rating >= 4).length}
                  </div>
